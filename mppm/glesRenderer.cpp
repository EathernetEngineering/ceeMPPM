...
void GLESRenderer::ClearColor(const glm::vec4 &color) {
	glClearColor(color.r, color.g, color.b, color.a);
}

void GLESRenderer::SetColor(const glm::vec4 &color) {
	m_ObjColor = color;
}

void GLESRenderer::DrawQuad(const glm::vec3 &position, const glm::vec3 &scale) {
